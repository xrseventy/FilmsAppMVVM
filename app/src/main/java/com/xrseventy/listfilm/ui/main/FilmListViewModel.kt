...
//class FilmListViewModel( filmsListRepository: FilmsListRepository) : ViewModel() { // TODO var 2
class FilmListViewModel() : ViewModel() {

    var movieList: MutableLiveData<List<MovieItem>> = MutableLiveData()


    // val movieList: LiveData<List<MovieItem>> = filmsListRepository.getListOfPopularMovies() // TODO var 2
    ...
    fun makeApiCall() {
        ...
        val popularMovieCall: Call<PopularMoviesList> =
            theMovieDbApiService.getMoviePopular(API_KEY, (Locale.getDefault().language.toString()))
